...
| **ResNet-Tr** | $\textcolor{red}{\text{ភ្លេ}}\text{ល}\textcolor{red}{\text{ខះ}}\text{ធិការដ្ឋាន}\text{ណៈក}\textcolor{red}{\text{ម្ព}}\text{ដិការដឹកនាំ}$ | $\text{និងកែសម្រួលសមាសភាពរាជរដ្ឋាភិបាល}\textcolor{red}{\text{នៃ}}\text{ព្រះរាជាណាចក្រកម្ពុជា}$ | $\text{ឧបនាយករដ្ឋម}\textcolor{red}{\text{ន្តី}}$ | $18\textcolor{red}{0}818125$ |
