...
| **ResNet-Tr** | $\textcolor{red}{\text{ភ្លេ}}\text{ល}\textcolor{red}{\text{ខះ}}\text{ធិការដ្ឋាន}$ $\textcolor{red}{\#}\text{ណៈក}\textcolor{red}{\text{ម្ព}}\text{ដិការដឹកនាំ}$ | $\text{និងកែសម្រួលសមាសភាព}$ $\text{រាជរដ្ឋាភិបាល}\textcolor{red}{\text{នៃ}}$ $\text{ព្រះរាជាណាចក្រកម្ពុជា}$ | $\text{ឧបនាយករដ្ឋម}\textcolor{red}{\text{ន្តី}}$ | $18\textcolor{red}{0}818125$ |
| **Tesseract** | $.\textcolor{red}{\text{«}}\text{ល}\textcolor{red}{\text{ខទ}}\text{ទិការដ្ឋាន}$ $\textcolor{red}{\text{ទ}}\text{ណៈក}\textcolor{red}{\text{ម្ពា}}\text{ធិការដឹក}\textcolor{red}{\text{ឆាំ}}$ | $\text{និងកែសម្រួលសមាសភាពរាជ}\textcolor{red}{\text{ន្ឋា}}\text{ភិបាល}$ $\text{នៃ}\textcolor{red}{\text{ទ្រះ}}\text{រាជាណាចក្រកម្ពុជា}$ | $\textcolor{red}{\text{ទូ}}\text{បនាយករដ្ឋមន្ត្រី}$ | 180818125 |
